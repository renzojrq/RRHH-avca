...
<div class="input-group input-group-md mb-3 col-md-8 margin-center">
	  ...
	  <table class="table-hover table-sm table-bordered" style="clear: both;">
                <thead class="thead-light thead-label-sm">
                  <tr>
                    ...
                    <th class="col-md-1 text-sm-center align-middle">Entrevista</th>
                    </tr>
                </thead>
                <tbody class="tbody-label-sm">
                  <tr>
                    ...
                    <td  class="text-sm-center align-middle"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#entrevista"><i class="fas fa-clipboard"></i></button></td>
                  </tr>
                  
                  <tr>
                    <td class="align-middle">22/12/2017</td>
                    <td class="align-middle">Leomar Alexander Esparragoza</td>
                    <td  class="text-sm-center align-middle"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#actualizartabulador"><i class="fas fa-clipboard"></i></button></td>
                  </tr>
  ...
  <div class="modal fade" id="entrevista" tabindex="-1" role="dialog" aria-labelledby="entrevista" aria-hidden="true" class="fondo-modal">
    ...
    <form>
       ...
       <table class="table table table-bordered" style="clear: both;">
                <thead class="thead-label">
                  <tr>
                    <th class="bg-dark"></th>
                    <th scope="col">Excelente</th>
                    <th scope="col">Sobre término medio</th>
                    <th scope="col">Término medio</th>
                    <th scope="col">Bajo término medio</th>
                ...
                <tbody class="tbody-label">
                  ...
                  <tr>
                    <th scope="row">Inteligencia Efectiva</th>
                    <td><div class="custom-control custom-radio">
                  ...
                  <tr>
                    <th scope="row">Facilidad de Expresión</th>
                     <td><div class="custom-control custom-radio">
                  ...
                  <tr>
                    <th scope="row">Habilidad para relacionarse</th>
                     <td><div class="custom-control custom-radio">
                  ...
                  <tr>
                    <th scope="row">Otros conocimientos</th>
                     <td><div class="custom-control custom-radio">
